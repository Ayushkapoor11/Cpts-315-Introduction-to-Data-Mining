...
x = pd.read_csv('C:/PA3/traindata.txt', header = None)
y = pd.read_csv('C:/PA3/trainlabels.txt',header=None)
z = pd.read_csv('C:/PA3/stoplist.txt',header = None)
predData =  pd.read_csv('D:/315/PA3/testdata.txt', header=None)
predLabels = pd.read_csv('D:/315/PA3/testlabels.txt', header=None)
